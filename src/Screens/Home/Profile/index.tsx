...
const ProfileScreen = () => {
  ...
  const menuItems = [
    ...
    {id: 6, title: 'Account details', icon: AccountDetails, screen: ACCOUNTDETAILS},
    {id: 7, title: 'Communication', icon: Communication, screen: COMMUNICATION},
    {id: 8, title: 'Log out', icon: Logout, screen: WELCOME}
  ];
