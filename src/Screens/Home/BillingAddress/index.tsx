...
import { setSelectedBillingAddress, removeBillingAddress } from 'src/store/slices/addressSlice';
...
const BillingAddress = () => {
  ...
  const { billingAddresses, selectedBillingAddressId } = useSelector((state: RootState) => state.address);
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptySubText}>Add a new billing address to continue</Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            <View style={styles.addressRight}>
                  ...
                  Alert.alert(
                    ...
                    [
                      {text: 'Cancel', style: 'cancel'},
                      {
                        text: 'Delete',
                        style: 'destructive',
                        onPress: () => dispatch(removeBillingAddress(address.id)),
                      },
                    ],
                  );
                }}>
              ...
              <View
                style={[
                  styles.radioButton,
                  selectedBillingAddressId === address.id && styles.radioButtonSelected,
                ]}
              />
            </View>
          </TouchableOpacity>
      ...
      <TouchableOpacity 
        style={[styles.addButton, !billingAddresses.length && {marginTop: 20}]} 
        onPress={() => {navigation.navigate(BILLING_ADDRESS_FORM)}}>
